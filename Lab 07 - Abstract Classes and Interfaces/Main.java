...
public class Main {
    ...
    public static void main(String[] args) {      
        ...
        // Menerima input user untuk karakteristik mobil
        for(int i = 0; i < P; i++){
            String nama = in.next();
        ...
        // Menerima perintah user untuk mobil
        int Q = in.nextInt();
        for(int i = 0; i < Q; i++) {
            String nama = in.next();
            ...
            // Melakukan program sesuai perintah
